import ch.skyfy.ghuperms.config.PermissionsConfig
import ch.skyfy.ghuperms.data.CommandPermission
import ch.skyfy.ghuperms.data.Player
...
//                        CommandPermission("command.homes", false),
                        CommandPermission("command.homes.create", true),
                        CommandPermission("command.homes.delete", true)
                    )
                )
            )
        )
